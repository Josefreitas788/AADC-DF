...
def graf_quant_dose123(request):
    ...
    return render(request, 'index.html', {'data1' : uri})

#######################Classificação por região geográfica.(estados do Brasil)#######################

def graf_regiao_geografica_estados(request):
...
def graf_regiao_geografica_paises(request):
